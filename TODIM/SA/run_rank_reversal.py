...
def main():
    old_candidates = todim.original_candidates.copy()
    old_ranks = todim.get_list()
    ...
    for candidate in old_candidates:
        ...
        new_dataframe = todim.original_dataframe.loc[new_candidates].to_numpy()

        new_ranks = todim.get_list(candidates=new_candidates, raw_data=new_dataframe)
